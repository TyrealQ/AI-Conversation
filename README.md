...
|---------|------------|--------------|
| [Basic NLP](./Basic-NLP/) | Code and guides for basic NLP applications using Hugging Face's Transformers library | - Sentiment analysis  <br> - Named Entity Recognition (NER) <br> - Text summarization <br> - Topic modeling |
| [Basic Multimodal](./Basic-Multimodal/) | Code and guides for basic image and speech processing with Hugging Face's Transformers library | - Image classification <br> - Speech recognition |
...
| [Agentic Workflows](https://github.com/TyrealQ/q-skills) | Agent skills and tools for writing, research, content creation, and creative work | - Agent skill development with Claude Code <br> - Multi-agent system design |
| [AI Ethics](./AI-Ethics/) | Research papers on ethical implications, risks, and societal impact of AI systems | - Hallucinations and factual reliability <br> - Bias and gender presentation in AI models <br> - Trust and privacy in AI systems <br> - AI safety and self-replication risks <br> - Algorithmic harms in human-AI relationships |
...
| Name                                                                                                                          | Description                                                                                                  |
|-------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| [CS224N: NLP with Deep Learning](https://web.stanford.edu/class/cs224n/)                                                      | A Stanford course on NLP with Deep Learning, covering models like Transformers and BERT. Videos are available from [here](https://www.youtube.com/playlist?list=PLoROMvodv4rMFqRtEuo6SGjY4XbRIVRd4).                    |
...
| [CS336: Language Modeling from Scratch](https://stanford-cs336.github.io/spring2025/)                                                          | A Stanford course on language models, designed to walk students through the entire process of developing their own. Videos are available from [here](https://www.youtube.com/playlist?list=PLoROMvodv4rOY23Y0BoGoBGgQ1zmU_MT_).                            |
| [SOC690: Computational Social Science](https://cbail.github.io/comp_soc_grad/Home.html) | A Duke course on the nascent inter-disciplinary field of computational social science, which combines insights from computer and information science, sociology and social network analysis, economics, political science, and public health. |
| [How To AI (Almost) Anything](https://mit-mi.github.io/how2ai-course/spring2025/) | An MIT course on how to apply AI to novel real-world data modalities. |
...
| [roboflow/notebooks](https://github.com/roboflow/notebooks)                                             | A collection of tutorials on state-of-the-art computer vision models and techniques. |
...
| [How we built our multi-agent research system](https://www.anthropic.com/engineering/built-multi-agent-research-system)                                          | An Anthropic research feature uses multiple Claude agents to explore complex topics more effectively. |
